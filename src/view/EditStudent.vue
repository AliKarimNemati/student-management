  ...
  <form class="p-20">
    <div class="space-y-12">
      <div class="border-b border-gray-900/10 pb-12">
        ...
        <p class="mt-1 text-sm leading-6 text-gray-600">
          Fill this form to Edit this student.
        </p>
    ...
    <div class="mt-6 flex items-center justify-center gap-x-6">
      ...
      <button
        ...
        @click.prevent="
          validation()
          error == '' && probs.editStudent(route.params.id, newStudent);
...
let newStudent = ref({
  id: probs.students.find((stu) => stu.id == route.params.id).id,
  firstName: probs.students.find((stu) => stu.id == route.params.id).firstName,
  lastName: probs.students.find((stu) => stu.id == route.params.id).lastName,
  mobile: probs.students.find((stu) => stu.id == route.params.id).mobile,
  nID: probs.students.find((stu) => stu.id == route.params.id).nID,
});
